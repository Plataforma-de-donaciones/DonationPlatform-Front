...
const VoluntarioListItem = ({ volunteer }) => {
  ...
  const construirURLCompartir = (volunteer, redSocial) => {
    const textoVoluntario = encodeURIComponent(`Mira el voluntariado: ${volunteer.vol_name}, publicado en DonacionesUy. Haz clic en el link para visualizarlo. ¡Se parte de DonacionesUy, transformamos intenciones en impacto social!`);
    ...
    switch (redSocial) {
      ...
      case 'instagram':
        ...
        case 'whatsapp':
          const mensajeWhatsAppV = encodeURIComponent(`Mira el voluntariado: ${volunteer.vol_name}, publicado en DonacionesUy. Haz clic en el link para visualizarlo. ¡Se parte de DonacionesUy, transformamos intenciones en impacto social!`);
          const urlWhatsAppV = encodeURIComponent(`https://donacionesuy.azurewebsites.net/listadovoluntariado`);
