...
<main>
    ...
    <Col1>
      <CardStyled className="card-alta">
        <Card.Header className="text-center h5">Ofrecimiento de equipamiento médico</Card.Header>
        <Card.Body>      
            ...
            <Form.Group className="mb-3" controlId="validationCustom01">
                  <Form.Label>¿Cuál es el equipamiento médico que puede donar?</Form.Label>
                  <Form.Control
                    as="textarea"
                    value={solicitudData["req_description"]}
                    required
                    type="text"
                    placeholder="Ingrese aquí la descripción de su equipamiento médico"
                    onChange={(event) =>
                  ...
                  <Form.Control.Feedback type="invalid">
                    Por favor ingrese la descripción de su equipamiento médico, no puede estar vacía.
                  </Form.Control.Feedback>
                  <Form.Control.Feedback>¡Campo válido!</Form.Control.Feedback>
