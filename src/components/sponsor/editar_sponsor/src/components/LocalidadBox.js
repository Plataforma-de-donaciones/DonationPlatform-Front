...
function LocalidadBox({ onChange, sponsorZone, setSponsorZone }) {
  const [zones, setZones] = useState([]);
  const [selectedZone, setSelectedZone] = useState("");
  console.log("coso zona", sponsorZone);
  ...
  const handleZoneChange = (event) => {
    ...
    if (setSponsorZone && typeof setSponsorZone === 'function') {
      setSponsorZone(selectedValue);
    }
  };
